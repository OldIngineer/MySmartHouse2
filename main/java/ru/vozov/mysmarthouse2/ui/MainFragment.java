...
public class MainFragment extends Fragment {
    private boolean[] mScan = new boolean[5];
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        CheckBox checkBoxComTelegram = v.findViewById(R.id.checkBox);
        checkBoxComTelegram.setChecked(mScan[4]);
        ...
        //создание класса-слушателя на событие нажатие checkBox - выбор управления через Telegram
        checkBoxComTelegram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mScan[4] = checkBoxComTelegram.isChecked();
                //запись изменения в признаки сканирования
                mListener.outAttributeScanNet(mScan);
            }
        });
